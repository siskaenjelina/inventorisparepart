...
<head>
    ...
    <title>Registrasi - Siska Maju Motor Inventory</title>
        ...
        <div class="split-right">
            <div class="login-wrapper">
                <div class="login-header">
                    ...
                    <p>Daftar untuk mengelola inventori.</p>
                </div>
                ...
                <form class="login-form" action="register_process.php" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-field">
                            ...
                            <input type="email" id="email" name="email" placeholder="admin@siskamajumotor.com" required autocomplete="off">
                        </div>
                    </div>
